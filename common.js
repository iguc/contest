...
// //セレクトメニュー
// window.onload = function () {
//   var mdSelect = document.querySelector(".md-select"),
//     mdSelectLi = document.querySelectorAll(".md-select ul li");

//   mdSelect.addEventListener("click", function (e) {
//     this.classList.toggle("active");
//     console.log(e, this);
//   });
//   for (var i = 0, len = mdSelectLi.length; i < len; i++) {
//     if (window.CP.shouldStopExecution(0)) break;
//     mdSelectLi[i].addEventListener("click", function (el) {
//       console.log(el, this);

//       var v = this.innerHTML;
//       for (var i = 0, len = mdSelectLi.length; i < len; i++) {
//         if (window.CP.shouldStopExecution(1)) break;
//         mdSelectLi[i].classList.remove("active");
//       }
//       window.CP.exitedLoop(1);
//       this.classList.add("active");
//       document.querySelector(".md-select label button").textContent = v;
//     });
//   }
